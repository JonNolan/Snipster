...
function register(req, res){
  ...
  connection.query("INSERT INTO Users (FirstName, LastName, Email, Password) VALUES (?, ?, ?, ?)", [req.query.firstname, req.query.lastname, req.query.email, req.query.password, hash], function (err, result, fields){
    if (err) {
